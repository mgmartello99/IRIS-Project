...
// https://svn.freebsd.org/base/head/lib/msun/src/s_sin.c

#if OPT_USE_FPU_SIN_
#error FPU precision for sine function is below expectation. Plz use Soft FP.
...
EXTERN_C double bsd_sin(double x)
{
	...
	if (ix <= 0x3fe921fb)
	{
		...
		RETURN_DOUBLE (__kernel_sin(x, z, 0));
	}
