...
/* Generated from ../O.Common/iris.dbd */
...
int iris_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/isolpharm_iris/EPICS/iris20250908";
...
/* iris_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: iris_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(iris_registerRecordDeviceDriver(*iocshPpdbbase));
}
