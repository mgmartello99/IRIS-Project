...
// https://svn.freebsd.org/base/head/lib/msun/src/s_ceil.c
...
#if OPT_USE_FPU_CEIL_

asm(
	"	.global bsd_ceil; .type	bsd_ceil, %function;\n"
	"	.global ceil; .type	ceil, %function;\n"
	"ceil:\n"
	"bsd_ceil:\n"
);
...
EXTERN_C double ceil(double x) ALIAS(bsd_ceil);

#endif	// OPT_USE_FPU_CEIL_
